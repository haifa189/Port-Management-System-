...
public class Ship implements IShip {
	...
	private List<Container> onShipContainerList = new ArrayList<>(); // List of containers currently on the ship.
	...
	public boolean load(Container cont) {
		return getOnShipContainerList().add(cont); //add containers to the list.
	}
