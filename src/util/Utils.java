...
public class Utils {
	static ShipOperations shipOperations = new ShipOperations();
	static ContainerOperations containerOperations = new ContainerOperations();
	...
	public static Container createAContainer(int ID, int weight, Optional<String> heavyType) {
	...
	public static Ship createAShip(int ID, Port port, int totalWeightCapacity, int maxNumberOfAllContainers,
	...
	public static List<Integer> loadingShipRestrictions(Ship ship) {
		int weightOfHeavyContainers = 0, weightOfBasicContainers = 0, numOfBasicContainers = 0,
	...
	public static void sailShipToPort(Ship ship, Port port) {
		...
		double distance = calculateDistance(ship.getCurrentPort().getLatitude(), ship.getCurrentPort().getLongitude(),
